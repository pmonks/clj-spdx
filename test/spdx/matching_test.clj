...
(deftest text-is-license?-tests
  ...
  (testing "Exactly matching official license texts"
    (is (true?  (text-is-license? apache-10-text          "Apache-1.0")))       ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/184
    (is (true?  (text-is-license? apache-11-text          "Apache-1.1")))       ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/184
    ...
    (is (true?  (text-is-license? cc-by-40-text           "CC-BY-4.0")))        ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (true?  (text-is-license? cc-by-sa-40-text        "CC-BY-SA-4.0")))     ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (true?  (text-is-license? cc-by-nc-40-text        "CC-BY-NC-4.0")))     ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (true?  (text-is-license? cc-by-nc-sa-40-text     "CC-BY-NC-SA-4.0")))  ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (true?  (text-is-license? cc-by-nd-40-text        "CC-BY-ND-4.0")))     ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (true?  (text-is-license? cc-by-nc-nd-40-text     "CC-BY-NC-ND-4.0")))  ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
...
(deftest text-contains-license?-tests
  ...
  (testing "Official license text contains license"
    (is (true?  (text-contains-license? apache-10-text          "Apache-1.0")))       ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/184
    (is (true?  (text-contains-license? apache-11-text          "Apache-1.1")))       ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/184
    ...
    (is (true?  (text-contains-license? cc-by-40-text           "CC-BY-4.0")))        ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (true?  (text-contains-license? cc-by-sa-40-text        "CC-BY-SA-4.0")))     ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (true?  (text-contains-license? cc-by-nc-40-text        "CC-BY-NC-4.0")))     ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (true?  (text-contains-license? cc-by-nc-sa-40-text     "CC-BY-NC-SA-4.0")))  ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (true?  (text-contains-license? cc-by-nd-40-text        "CC-BY-ND-4.0")))     ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (true?  (text-contains-license? cc-by-nc-nd-40-text     "CC-BY-NC-ND-4.0")))  ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
  ...
  (testing "3rd party license text contains license"
    ...
    (is (true?  (text-contains-license? commonmark-java-license "BSD-2-Clause"))))  ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/182
  (testing "Larger texts with junk characters contain licenses"
    (is (true?  (text-contains-license? (str "ABCD\n" apache-20-text          "\nEFGH") "Apache-2.0")))
    (is (true?  (text-contains-license? (str "ABCD\n" gpl-30-text             "\nEFGH") "GPL-3.0")))
    (is (true?  (text-contains-license? (str "ABCD\n" cc-by-40-text           "\nEFGH") "CC-BY-4.0")))          ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (true?  (text-contains-license? (str "ABCD\n" mpl-20-text             "\nEFGH") "MPL-2.0")))
    (is (true?  (text-contains-license? (str "ABCD\n" clj-spdx-license        "\nEFGH") "Apache-2.0")))
...
;    (is (true?  (text-contains-license? jffi-text                                       "LGPL-3.0-or-later")))  ; Blocked on https://github.com/jnr/jffi/issues/141
    (is (true?  (text-contains-license? (str "ABCD\n" commonmark-java-license "\nEFGH") "BSD-2-Clause")))))     ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/182
...
(deftest licenses-within-text-tests
  ...
  (testing "Matching official license texts"
    (is (= (licenses-within-text apache-10-text)      #{"Apache-1.0"}))       ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/184
    (is (= (licenses-within-text apache-11-text)      #{"Apache-1.1"}))       ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/184
    ...
    (is (= (licenses-within-text cc-by-40-text)       #{"CC-BY-4.0"}))        ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (= (licenses-within-text cc-by-sa-40-text)    #{"CC-BY-SA-4.0"}))     ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (= (licenses-within-text cc-by-nc-40-text)    #{"CC-BY-NC-4.0"}))     ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (= (licenses-within-text cc-by-nc-sa-40-text) #{"CC-BY-NC-SA-4.0"}))  ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (= (licenses-within-text cc-by-nd-40-text)    #{"CC-BY-ND-4.0"}))     ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (= (licenses-within-text cc-by-nc-nd-40-text) #{"CC-BY-NC-ND-4.0"}))  ; Blocked on https://github.com/spdx/license-list-XML/issues/1960
    (is (= (licenses-within-text wtfpl-text)          #{"WTFPL"}))            ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/182
  ...
  (testing "Matching 3rd party license texts that only contain a single license"
    ...
    (is (= (licenses-within-text commonmark-java-license) #{"BSD-2-Clause"})))    ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/182
  (testing "Matching larger texts with junk characters and a single license"
    ...
    (is (= (licenses-within-text (str "ABCD\n" wtfpl-text              "\nEFGH")) #{"WTFPL"}))          ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/182
    (is (= (licenses-within-text (str "ABCD\n" clj-spdx-license        "\nEFGH")) #{"Apache-2.0"}))
    (is (= (licenses-within-text (str "ABCD\n" commonmark-java-license "\nEFGH")) #{"BSD-2-Clause"})))  ; Blocked on https://github.com/spdx/Spdx-Java-Library/issues/182
  (testing "Matching larger texts with multiple licenses and (optionally) other text (e.g. exceptions) that shouldn't match"
    ...
    (is (= (licenses-within-text javamail-license)                   #{"CDDL-1.1"   "GPL-2.0"}))             ; Blocked on https://github.com/spdx/license-list-XML/issues/1972
...
(deftest exceptions-within-text-tests
  ...
  (testing "Texts with multiple licenses/exceptions"
    ...
    (is (= (exceptions-within-text javamail-license)                   #{"Classpath-exception-2.0"}))))    ; Blocked on https://github.com/spdx/license-list-XML/issues/1972
